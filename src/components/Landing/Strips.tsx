        ...
        <div className="flex flex-col-reverse justify-between lg:ml-32 lg:flex-row">
          <div className="lg:w-1/2">
            ...
            <p className="mt-8 lg:text-lg">
              Die dekorativ ummantelten UMA<sup>&reg;</sup>-Leisten, für den nahezu dekorgleichen Abschluss an Boden und
              Decke, gibt es in vier Formaten.
            </p>
          ...
          <div className="lg:w-1/3 lg:-mt-4 lg:mr-12">
            <picture className="block mt-12 lg:-mx-24">
              ...
              <img src="/images/hdm-leisten.jpg" alt="Möbelbauplatten - modernen Regalböden und Möbelbauplatten" />
            </picture>
          </div>
        </div>
      </div>
