...
const Privacy: React.FC = () => {
  return (
    <Layout title="Datenschutz * HDM &ndash; Holz Design Moers">
      <article className="container max-w-3xl">
        <h1 className="mt-16 text-4xl font-bold">Datenschutz&shy;erkl&auml;rung</h1>
        <h2 className="mt-16 text-3xl">1. Datenschutz auf einen Blick</h2>
        <h3 className="mt-16 text-2xl">Allgemeine Hinweise</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Datenerfassung auf dieser Website</h3>
        <h4 className="mt-8 text-xl">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
        <p className="mt-8">
        ...
        <h4 className="mt-8 text-xl">Wie erfassen wir Ihre Daten?</h4>
        <p className="mt-8">
        ...
        <h4 className="mt-8 text-xl">Wof&uuml;r nutzen wir Ihre Daten?</h4>
        <p className="mt-8">
        ...
        <h4 className="mt-8 text-xl">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
        <p className="mt-8">
        ...
        <h4 className="mt-8 text-xl">Abschluss eines Vertrages &uuml;ber Auftragsverarbeitung</h4>
        <p className="mt-8">
        ...
        <h2 className="mt-16 text-3xl">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
        <h3 className="mt-16 text-2xl">Datenschutz</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Hinweis zur verantwortlichen Stelle</h3>
        <p className="mt-8">Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>
        <p className="mt-8">
        ...
        <p className="mt-8">
          Telefon: <a href="tel:+49284114010">+49 2841 1401 0</a> <br />
          Telefax: +49 2841 1401 180 <br />
          E-Mail: <a href="mailto:info@hdm.gmbh">info@hdm.gmbh</a>
        </p>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Auskunft, L&ouml;schung und Berichtigung</h3>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
        <p className="mt-8">
        ...
        <ul className="pl-8 mt-8 list-disc">
          <li>
        ...
        <h2 className="mt-16 text-3xl">4. Datenerfassung auf dieser Website</h2>
        <h3 className="mt-16 text-2xl">Server-Log-Dateien</h3>
        <p className="mt-8">
        ...
        <p className="mt-8">Eine Zusammenf&uuml;hrung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.</p>
        <p className="mt-8">
        ...
        <h3 className="mt-16 text-2xl">Anfrage per E-Mail, Telefon oder Telefax</h3>
        <p className="mt-8">
        ...
        <h2 className="mt-16 text-3xl">5. Plugins und Tools</h2>
        <h3 className="mt-16 text-2xl">Google Web Fonts</h3>
        <p className="mt-8">
