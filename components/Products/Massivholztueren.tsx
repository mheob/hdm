...
const Massivholztueren: React.FC<Props> = ({ className = "" }: Props) => {
  return (
    <Section className={`container bg-gray-100 relative pt-20 pb-20 lg:mt-24 ${className}`}>
      <header className="lg:ml-32 lg:mt-16">
        <div>
      ...
      <div className="lg:-mt-32 lg:ml-32">
        <p className="mt-12 lg:text-lg">
          Sorglos die Schönheit massiven Holzes genießen. Massivholz sorgt für behagliche Wärme und ist nie langweilig.
        </p>
        <p className="mt-8 lg:text-lg">
          Denn Holz ist pure Natur und bringt eine angenehme, freundliche Atmosphäre ins Haus, unterstrichen von ruhigen
          Licht- und Schattenspielen der offenen Lamellen- und Gittertüren.
        </p>
